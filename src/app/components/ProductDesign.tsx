          ...
          >
            ...
            <div className="grid md:grid-cols-12 gap-8 md:gap-4 items-start">
              ...
              <div className="md:col-span-7 lg:col-span-6 lg:col-start-7">
                ...
                <button className="inline-flex items-center space-x-2 text-sm font-bold border-b-2 border-zinc-900 pb-1 hover:text-zinc-600 hover:border-zinc-600 transition-colors uppercase tracking-wider group-hover:text-zinc-600">
